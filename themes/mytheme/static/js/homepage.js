...
function startAnim(){ if(!document.getElementById("cv")){setTimeout(startAnim,50);return;} rsz(); requestAnimationFrame(frame); } if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",startAnim);}else{startAnim();}
